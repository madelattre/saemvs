...
#' session.
#'
#' @param g_fun A user-defined R function of the form \code{g(phi, t)}
...
#' into C++.
#' @param build_dir Character string indicating the directory where compiled
...
#'
#' Internal function that dynamically loads a compiled shared object
#' (\code{.so}) file containing a previously compiled model. This provides
#' direct access to the C++ functions generated by \code{\link{compile_model}}.
#'
